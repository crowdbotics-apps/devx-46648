"""
Django settings for devx_46648 project.
...
WSGI_APPLICATION = 'devx_46648.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "devx_46648 API",
    "DESCRIPTION": "API documentation for devx_46648 App",
    "VERSION": "v1",
}
